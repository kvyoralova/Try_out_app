...
if language == 'Русский':
  ...
  if placechoice == 'Площадка для игр':
    ...
    st.write(pd.DataFrame({
     'first column': ["1. Пойдем в парк", "2. Давай играть в прятки", "3. Давай покатаемся на качелях"],
     'second column': ["Andiamo al parco", "Giochiamo a nascondino", "Andiamo sull'altalena"],}))
